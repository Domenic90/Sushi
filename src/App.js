          ...
          <div className="row">
            {this.state.cards.map(card => (
              <Card
                ...
                diminuisci={this.DecrementaQauntita}
              />
            ))};
          </div>
        </div>
    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route exact path='riepilogoOrdine' element={
            <RiepilogoOrdine />}>
          </Route>
